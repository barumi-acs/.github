...
|-----------|-------------|------|
| [PlanIt-FE](https://github.com/barumi-acs/PlanIt-FE) | PlanIt 프론트엔드 애플리케이션 | TypeScript |
| [Planit-manifests](https://github.com/barumi-acs/Planit-manifests) | Kubernetes 배포 매니페스트 관리 | YAML |
| [PlanIt-Strategy-svc](https://github.com/barumi-acs/PlanIt-Strategy-svc) | 카테고리 기반 트렌드 분석과 AI 목표 및 실행 계획 생성을 담당하는 전략 서비스 | Java |
| [PlanIt-Insight-svc](https://github.com/barumi-acs/PlanIt-Insight-svc) | 사용자 수행 데이터 기반 피드백 리포트 서비스 | Java |
| [PlanIt-Schedule-svc](https://github.com/barumi-acs/PlanIt-Schedule-svc) | 목표, 일정, Todo 관리를 담당하는 스케줄 서비스 | Java |
| [PlanIt-User-svc](https://github.com/barumi-acs/PlanIt-User-svc) | 회원가입, 로그인, 인증 및 사용자 관리를 담당하는 서비스 | Java |
| [PlanIt-InsightAI-svc](https://github.com/barumi-acs/PlanIt-InsightAI-svc) | AI 기반 리포트 생성을 담당하는 Python AI 서비스 | Python |
| [PlanIt-Terraform](https://github.com/barumi-acs/PlanIt-Terraform) | AWS 인프라 프로비저닝을 위한 Terraform 코드 | HCL |
| [PlanIt-base-template](https://github.com/barumi-acs/PlanIt-base-template) | Spring Boot 기반 서비스 공통 템플릿 | Java |
